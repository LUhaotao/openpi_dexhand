...
def test_build_zero_observation_for_continuous_state_fake_env():
    observation = build_zero_observation("franka_xhand_continuous_state", state_dim=18, height=16, width=20)
